...
async function fakeDocument () {
    ...
    const entryCount = Math.floor(Math.random() * 12) + 1;

    for (var i = 0; i < entryCount; i++ ) {
        var entry = await fakeEntry();
        content.push(entry);
    }
